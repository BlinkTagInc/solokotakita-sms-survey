...
module.exports = {
  ...
  resetQuestion: function(app, req, res) {
    ...
    Survey.findOne({src: req.query.src}, function(e, survey) {
      ...
      sendMessage(app, req, res, resetMessage, req.query.src, (survey.answers.length + 1));
    });
  },
  ...
  resetSurvey: function(app, req, res) {
    ...
    Survey.remove({src: req.query.src}, function(e) {
      sendMessage(app, req, res, resetMessage, req.query.src, 1);
    });
  },
  ...
  doPing: function(app, req, res) {
    ...
    smsUtils.sendMessage(pingText, req.query.src, function(e, response){
      var sms = new Sms({
          date: ''
        , src: 'SKK'
        , dst: req.query.src
